...
class Quiz extends JFrame{
    ...
    Quiz() {
        super("Quiz Matematika Sederhana");
        ...
        lhasil = new JLabel("Jawab dengan benar :)");
        ...
        lhasil.setFont(new Font("Time New Roman", Font.PLAIN, 20));
        ...
        check.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent ae) {
                ...
                if (no3==answerkey){
                    ...
                    add(lhasil);
                    lhasil.setBounds(50,150,400,30); 
                    lhasil.setForeground(Color.GREEN);
                } else {
                    lhasil = new JLabel("Maaf ! Jawaban anda Salah !!!");
                    add(lhasil);
                    lhasil.setBounds(50,150,400,30);
                    lhasil.setForeground(Color.RED);  
                } 
                lhasil.setFont(new Font("Time New Roman", Font.PLAIN, 20));
            }
    }); 
