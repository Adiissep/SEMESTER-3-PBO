...
class Exam {
  ...
  public void getSummaryOfStudents() {
    ...
    for (Mahasiswa[] studentsByGrade: categorizedStudentsByGrade) {
      if (studentsByGrade[0] != null) {
        ArrayList<Mahasiswa> students = new ArrayList<Mahasiswa>(Arrays.asList(studentsByGrade));
        System.out.println("Jumlah Mahasiswa dengan Nilai " + studentsByGrade[0].getGrade() + " yaitu " + this.mapStudents(students)); 
      }
    }
  }
  ...
  public void getExamResult() {
    ...
    if(this.passedStudents.size()==0){
       System.out.println("Jumlah Mahasiswa yang lulus        : " + this.passedStudents.size());
    }else{
       System.out.println("Jumlah Mahasiswa yang lulus        : " + this.passedStudents.size() +"  (" + this.mapStudents(this.passedStudents)+")"); 
    }
    
    
    if(this.failedStudents.size()==0){
       System.out.println("Jumlah Mahasiswa yang tidak lulus  : " + this.failedStudents.size());
    }else{
       System.out.println("Jumlah Mahasiswa yang tidak lulus  : " + this.failedStudents.size()+"  (" + this.mapStudents(this.failedStudents)+")"); 
    }
